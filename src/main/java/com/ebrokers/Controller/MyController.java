...
public class MyController {
	...
	@GetMapping("getPropertyByMeId/{meid}")
	@ResponseBody
	public List<Property> getPropertyByMeId(@PathVariable Integer meid) {
		logger.info("In getPropertyByMeId : " + meid);
		return propertyRepository.getPropertyByMeId(meid);
	}
}