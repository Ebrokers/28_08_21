...
public class MyController {
	...
	@GetMapping("getByMeId/{meid}")
	@ResponseBody
	public List<Property> getByMeId(@PathVariable Integer meid) {
		logger.info("In getByMeId : " + meid);
		return propertyRepository.getByMeId(meid);
	}
}